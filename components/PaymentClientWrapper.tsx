...
import { Star, Users, Shield, CreditCard, ArrowLeft, CheckCircle } from "lucide-react"
import Image from "next/image"
import { CourseMinimal } from "@/types/course"


const PaymentClientWrapper = ({programId, course}: {programId: string, course: CourseMinimal}) => {
                        ...
                        <div className="sticky top-8">
                            <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm">
                                <CardContent className="p-6">
                                    ...
                                    <Button
                                        onClick={() => handlePayment(course!.price!.toString())}
