...
const SearchPage = () => {
    ...
    }, [finalCourses, filterCategory])

    useEffect(() => {
        if (!finalCourses) return

        let result = [...finalCourses]
    ...
    }, [finalCourses, filters, searchTerm])
                        ...
                        <div className="space-y-3">
                            {finalCategories.map(({category}) => (
                                <div key={category} className="flex items-center space-x-2">
                                    ...
                                    <Label className="capitalize" htmlFor={category}>{category}</Label>
                                </div>
                            ))}
                        </div>
                    </div>
